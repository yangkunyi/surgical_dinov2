...
def collate_data_and_cast_with_depth(
    samples_list,
    mask_ratio_tuple,
    mask_probability,
    dtype,
    ...
    collated_depth = torch.stack([s[4] for s in samples_list])
    collated_raw_image = torch.stack([s[3] for s in samples_list])
    return {
        "collated_global_crops": collated_global_crops.to(dtype),
        "collated_local_crops": collated_local_crops,
        "collated_masks": collated_masks,
        ...
        "collated_depth": collated_depth.to(dtype),
        "collated_raw_image": collated_raw_image.to(dtype),
    }


def collate_data_and_cast_with_depth_and_mask(
    samples_list,
    mask_ratio_tuple,
    mask_probability,
    dtype,
    ...
    collated_depth = torch.stack([s[4] for s in samples_list])
    collated_raw_image = torch.stack([s[3] for s in samples_list])
    collated_segmentation = torch.stack([s[5] for s in samples_list])
    return {
        "collated_global_crops": collated_global_crops.to(dtype),
        "collated_local_crops": collated_local_crops,
        "collated_masks": collated_masks,
        ...
        "collated_depth": collated_depth.to(dtype),
        "collated_raw_image": collated_raw_image.to(dtype),
        "collated_segmentation": collated_segmentation,
    }
